	...
	def mainThread(self):
		...
		try:
			...
			while(vsiCommonPythonApi.getSimulationTimeInNs() < self.totalSimulationTime):
				...
				vsiCanPythonGateway.setCanPayloadBits(self.packBytes('d', self.mySignals.robot_pose), 0, 64)
				vsiCanPythonGateway.setDataLengthInBits(64)
				vsiCanPythonGateway.sendCanPacket()

				vsiCanPythonGateway.setCanId(12)
				vsiCanPythonGateway.setCanPayloadBits(self.packBytes('d', self.mySignals.reference_path), 0, 64)
				vsiCanPythonGateway.setDataLengthInBits(64)
				vsiCanPythonGateway.sendCanPacket()
				...
				print("  Inputs:")
				print("\tcmd_vel =", end = " ")
				print(self.mySignals.cmd_vel)
				print("  Outputs:")
				print("\trobot_pose =", end = " ")
				print(self.mySignals.robot_pose)
				print("\treference_path =", end = " ")
				print(self.mySignals.reference_path)
				print("\n\n")
